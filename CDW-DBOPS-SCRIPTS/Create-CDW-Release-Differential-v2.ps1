...
function Build-GitFileList{
    ...
    if($FilterString -ne ''){
        ...
        $FileList | get-item | foreach-object {
            ...
            {
                $Filtered_FileList += $file_fullname
            } 
        }
...
foreach($filekey in $diff_hash.Keys.ToString())
{
...
# # BELOW THIS LINE ... BROKEN. BELOW THIS LINE ... BROKEN. BELOW THIS LINE ... BROKEN. BELOW THIS LINE ... BROKEN. BELOW THIS LINE ... BROKEN.
